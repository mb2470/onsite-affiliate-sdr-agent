...
- If you hit 85 words, consider stopping
- 90 words is the ABSOLUTE MAXIMUM
- Shorter is better (aim for 60-80 words)
...
${emailType === 'followup' ? `
FOLLOW-UP EMAIL (even shorter - 65 words max):
...
${emailType === 'breakup' ? `
BREAKUP EMAIL (shortest - 50 words max):
- Final attempt
